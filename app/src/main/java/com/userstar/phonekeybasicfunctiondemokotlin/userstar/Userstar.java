package com.userstar.phonekeybasicfunctiondemokotlin.userstar;
...
public class Userstar {
    public static String random_value(int difficult, int num) {
        ...
        for(int i = 0; i < num; ++i) {
            if (difficult == 1) {
                ls_random.append((int) (Math.random() * 10.0D));
            } else {
                String[] readomHard;
                int readomWordIndex;
                if (difficult == 2) {
                    ...
                    ls_random.append(readomHard[readomWordIndex]);
                } else if (difficult == 3) {
                    char readomLetter = (char)((int)(Math.random() * 26.0D + 97.0D));
                    ls_random.append(String.valueOf(readomLetter));
                } else if (difficult == 4) {
