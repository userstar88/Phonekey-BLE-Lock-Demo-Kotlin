...
public class ustag {
    ...
    public byte[] WSB(int blockno, byte[] data) throws IOException, WSB25FailException {
        ...
        while(true) {
            try {
                ...
                if (blockno == 25) {
                    ...
                    throw new WSB25FailException(exception.toString());
                }
    ...
    public void WMBbyWSB(int blockno, byte[] data) throws IOException, WSB25FailException, InterruptedException {
